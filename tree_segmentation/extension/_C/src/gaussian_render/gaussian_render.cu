...
__global__ void __launch_bounds__(BLOCK_X* BLOCK_Y) renderCUDA_backward(const uint2* __restrict__ ranges,
    const uint32_t* __restrict__ point_list, int W, int H, /*const float* __restrict__ bg_color,*/
...
void render_backward(const dim3 grid, const dim3 block, const uint2* ranges, const uint32_t* point_list, int W, int H,
  ...
  switch (E) {
    case 0:
      renderCUDA_backward<NUM_CHANNELS, 0> KERNEL_ARG(grid, block)(ranges, point_list, W, H, means2D, conic_opacity,
      ...
      break;
    case 1:
      renderCUDA_backward<NUM_CHANNELS, 1> KERNEL_ARG(grid, block)(ranges, point_list, W, H, means2D, conic_opacity,
          colors, extras, out_opacity, n_contrib, dL_dpixels, dL_dout_extras, dL_dout_opacity, dL_dmean2D, dL_dconic2D,
          dL_dopacity, dL_dcolors, dL_dextras);
      break;
    case 2:
      renderCUDA_backward<NUM_CHANNELS, 2> KERNEL_ARG(grid, block)(ranges, point_list, W, H, means2D, conic_opacity,
          colors, extras, out_opacity, n_contrib, dL_dpixels, dL_dout_extras, dL_dout_opacity, dL_dmean2D, dL_dconic2D,
          dL_dopacity, dL_dcolors, dL_dextras);
      break;
    case 3:
      renderCUDA_backward<NUM_CHANNELS, 3> KERNEL_ARG(grid, block)(ranges, point_list, W, H, means2D, conic_opacity,
          colors, extras, out_opacity, n_contrib, dL_dpixels, dL_dout_extras, dL_dout_opacity, dL_dmean2D, dL_dconic2D,
          dL_dopacity, dL_dcolors, dL_dextras);
      break;
    case 4:
      renderCUDA_backward<NUM_CHANNELS, 4> KERNEL_ARG(grid, block)(ranges, point_list, W, H, means2D, conic_opacity,
          colors, extras, out_opacity, n_contrib, dL_dpixels, dL_dout_extras, dL_dout_opacity, dL_dmean2D, dL_dconic2D,
          dL_dopacity, dL_dcolors, dL_dextras);
      break;
...
std::tuple<Tensor, at::optional<Tensor>, Tensor, Tensor, Tensor> gaussian_rasterize_backward(int weight, int height,
  ...
  render_backward(tile_grid, block, imgState.ranges, binningState.point_list, W, H, E, geomState.means2D,
