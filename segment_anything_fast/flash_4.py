...
def _attention_rel_h_rel_w_kernel_aligned(q, k, v, rel_h_w, sm_scale):
    ...
    _attention_rel_h_rel_w_kernel_aligned_device(
        q, k, v, rel_h_w, sm_scale, o, best_config[0], best_config[1], best_config[2], best_config[3])
    return o
...
def _attention_rel_h_rel_w(q_, k_, v_, rel_h_, rel_w_):
    ...
    def kernel_guards(q_, k_, v_):
        return (
            q_.dtype == torch.bfloat16 or q_.dtype == torch.float16) and q_.dtype == k_.dtype and k_.dtype == v_.dtype and USE_CUSTOM_KERNEL
