...
class TreeSegmentGUI(TreeSegment):
    ...
    def levels_3d(self, levels: list):
        ...
        if self.mode == 'E3D':
            self.not_show_tree(self._3d_levels)
        ...
        if dpg.is_item_hovered(self.view_3d.image_tag):
            ...
            if self._3d_mask is not None:
                ...
                if mask_id < 0:
                    ...
                    mask = self.aux_data_3d[self.levels_3d[self.now_level_3d][mask_id].item()][0]
    ...
    def make_3d_edit_options(self):
        ...
        with dpg.group(horizontal=True):
            dpg.add_button(
                ...
                width=W,
                height=H,
                callback=lambda: dpg.show_item("choose_mesh")
            )
        ...
        with dpg.group(horizontal=True):
            ...
            dpg.add_slider_float(
                ...
                default_value=0.5,
                tag='edit_threshold',
                callback=self.set_edit_3d_threshold
            )
